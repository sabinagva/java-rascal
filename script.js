...
function calculateDiscount(product) {
	...
	console.log('function is', getReviewDiscount(product));
	...
	console.log('PRICE ADJUSTEMNT IS',priceAdjustment);
	console.log('year ADJUSTEMNT IS',yearAdjustment);
	console.log('review discount  IS',reviewDiscount);
...
console.log('product price is', discountPercent);
